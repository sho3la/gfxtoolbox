...
_draw_scene()
{
	...
	gfx_backend->setGPUProgramFloat(scene_gpu_program, "scale", scene_cyclorama->scale_val);
	gfx_backend->setGPUProgramVec3(scene_gpu_program, "color1", scene_cyclorama->color1);
	gfx_backend->setGPUProgramVec3(scene_gpu_program, "color2", scene_cyclorama->color2);
	gfx_backend->draw(
		gfx::GFX_Primitive::TRIANGLES,
		scene_cyclorama->gpu_mesh_id,
		scene_cyclorama->vertices.size() / 8);
